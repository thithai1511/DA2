...
export default function Capture(){
  ...
  async function start(){
    ...
    setRunning(true);
    try{ await api("/api/capture",{method:"POST", body: JSON.stringify({student_id:sid})}); }
  ...
  return (
    <Card title="Enroll / Capture faces">
      ...
      <p className="text-sm text-slate-500 mt-3">Neu preview xuat hien tren Pi, bam q de dung som.</p>
    </Card>
  );
}
